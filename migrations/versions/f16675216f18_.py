...
Revision ID: f16675216f18
Revises: a1c879035a61
Create Date: 2021-05-16 20:42:01.009212
...
revision = 'f16675216f18'
down_revision = 'a1c879035a61'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('user', sa.Column('personal_id', sa.String(length=120), nullable=True))
